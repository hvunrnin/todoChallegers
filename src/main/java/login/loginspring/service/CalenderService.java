...
import login.loginspring.repository.CalenderRepository;
    ...
    public ArrayList<String> renderCalender(ArrayList<String> data) {
        ...
        for(int i=0; i<data.size(); i++) {
            ...
            if(data.get(i)==""){
                ...
                h_calender.add("<td>"+"<button type=\"button\" value=\"data.get(i)\" id=\"date\" class=\"c_btn\" onclick=\"display()\"></button>"+data.get(i)+"</td>");
            }
        }
        h_calender.add("/<tr>");
